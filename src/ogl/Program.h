...
#define _OGL_PROGRAM_ATTRIB_N_UNIFORM_SETTERS(OGL_TYPE) \
...
\
        ...
        _OGL_PROGRAM_ATTRIB_N_UNIFORM_SETTERS(GLfloat)
        _OGL_PROGRAM_ATTRIB_N_UNIFORM_SETTERS(GLdouble)
        _OGL_PROGRAM_ATTRIB_N_UNIFORM_SETTERS(GLint)
        _OGL_PROGRAM_ATTRIB_N_UNIFORM_SETTERS(GLuint)
